...
def main():
    ...
    /* Make necessary containers transparent to show background */
    .stApp, section, [data-testid="stHeader"], [data-testid="stToolbar"],
    [data-testid="stDecoration"], [data-testid="stAppViewContainer"] {
