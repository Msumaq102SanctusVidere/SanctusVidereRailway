...
"""
    ...
    # Headers
    markdown_text = re.sub(r'^# (.*?)# --- Filename: ui/app.py (Frontend Streamlit UI - Fixed User Workspace Initialization) ---
# REVISED: Fixed workspace initialization to only happen once per user
# REVISED: Ensured drawings are always fetched on initial load
# REVISED: Added blueprint grid background to match homepage
...
if __name__ == "__main__":
    main()
, r'<h1>\1</h1>', markdown_text, flags=re.MULTILINE)
    markdown_text = re.sub(r'^## (.*?)# --- Filename: ui/app.py (Frontend Streamlit UI - Fixed User Workspace Initialization) ---
# REVISED: Fixed workspace initialization to only happen once per user
# REVISED: Ensured drawings are always fetched on initial load
# REVISED: Added blueprint grid background to match homepage
...
if __name__ == "__main__":
    main()
, r'<h2>\1</h2>', markdown_text, flags=re.MULTILINE)
    markdown_text = re.sub(r'^### (.*?)# --- Filename: ui/app.py (Frontend Streamlit UI - Fixed User Workspace Initialization) ---
# REVISED: Fixed workspace initialization to only happen once per user
# REVISED: Ensured drawings are always fetched on initial load
# REVISED: Added blueprint grid background to match homepage
...
if __name__ == "__main__":
    main()
, r'<h3>\1</h3>', markdown_text, flags=re.MULTILINE)
...
if __name__ == "__main__":
    main()
, r'<li>\1</li>', markdown_text, flags=re.MULTILINE)
    markdown_text = re.sub(r'^(\d+)\. (.*?)# --- Filename: ui/app.py (Frontend Streamlit UI - Fixed User Workspace Initialization) ---
# REVISED: Fixed workspace initialization to only happen once per user
# REVISED: Ensured drawings are always fetched on initial load
# REVISED: Added blueprint grid background to match homepage
...
if __name__ == "__main__":
    main()
, r'<li>\2</li>', markdown_text, flags=re.MULTILINE)
...
def main():
    ...
    /* FIXED: Make Streamlit containers transparent - ONLY background, not layout */
    .stApp, section, .stTabs, [data-testid="stHeader"], [data-testid="stToolbar"], .main,
    ...
    /* Style sidebar with blue gradient from homepage */
    [data-testid="stSidebar"] {
        background: linear-gradient(135deg, rgba(30, 30, 30, 0.8), rgba(20, 30, 45, 0.8)) !important;
        border-right: 1px solid rgba(100, 181, 246, 0.1) !important;
    }
    
    /* Style the left column (Drawing Selection) with blue styling matching homepage */
    [data-testid="stHorizontalBlock"] > div:nth-child(1) {
        background: linear-gradient(135deg, rgba(30, 30, 30, 0.8), rgba(20, 30, 45, 0.8)) !important;
        border-radius: 12px !important;
        padding: 25px !important;
    ...
    /* Add blueprint corner accents to columns */
    [data-testid="stHorizontalBlock"] > div:before {
        content: '';
        position: absolute;
        top: 0;
    ...
    /* Title and other original styling */
    .big-title {
        font-size: 3rem !important;
        margin-top: -1.5rem !important;
        margin-bottom: 0.5rem !important;
...
if __name__ == "__main__":
    main()# --- Filename: ui/app.py (Frontend Streamlit UI - Fixed User Workspace Initialization) ---
# REVISED: Fixed workspace initialization to only happen once per user
# REVISED: Ensured drawings are always fetched on initial load
# REVISED: Added blueprint grid background to match homepage
